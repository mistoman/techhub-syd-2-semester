<template>
    ...
    <div class="join-us-sec">
        <div class="join-us-text">
            <h2>HOW CAN <br> <span class="main-text-color-purble"> YOU JOIN US?</span></h2>

            <p class="join-us-header-text"> <span class="main-text-color-purble"> Online </span></p>
            <p class="join-us-info-text">1. Fill out this form.</p>
            <p class="join-us-info-text">2. Wait for our answer email.</p>

            <p class="join-us-header-text"> <span class="main-text-color-purble"> OFFLINE </span></p>
            <p class="join-us-info-text">1. Show up at one of our offices</p>
        </div>
